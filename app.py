...
#  login app  ----------------------------- 
    ...
    def loginform(self):
        ...
        admin_radio = Radiobutton(self.lform,text="مدیر",variable=self.role_var,value="مدیر" , font=("Vazir",12))
        admin_radio.place(x=30,y=130)

        customer_radio = Radiobutton(self.lform,text="مشتری",variable=self.role_var,value="مشتری" , font=("Vazir",12))
